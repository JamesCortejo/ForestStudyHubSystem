...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' data: gap: https://ssl.gstatic.com;
              ...
              frame-src 'none'">
    <title>Shop</title>
    <link rel="stylesheet" href="../../css/shop_ch.css">
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="fw-bold">Total: ₱<span id="modalTotal"></span></div>
                </div>
    ...
    <div class="container py-5" style="margin-top: 76px;">
        <div class="row g-5"> <!-- Removed d-flex align-items-stretch -->
            <!-- Left Column - Order Summary -->
            <div class="col-lg-8">
                <div class="order-summary w-100">
                    <h2 class="mb-4">Order Summary</h2>
                    <div id="cartItems">
                        <?php include 'backend/checkout_items.php'; ?>
                    </div>
            ...
            <div class="col-lg-4 d-flex">
                <div class="payment-section w-100">
                    ...
                    <form id="checkoutForm">
                        ...
                        <!-- GCash QR Code -->
                        <div id="gcashQrContainer" class="d-none">
                            <p class="text-muted">Please scan the QR code to complete payment:</p>
                            <img src="../../resources/qr.png" alt="GCash QR Code" class="img-fluid qr-code"
                                id="gcashQrCode">
                        </div>
